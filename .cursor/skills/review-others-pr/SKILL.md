...
4. **Review for**
   ...
   - API client vs ad-hoc fetch
   - Tenant slug / routing mistakes
   - Secrets, token logging, spoof JWT changes
   - Missing tests for auth/tenant/API changes
