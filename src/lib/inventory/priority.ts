...
export function inventoryPriorityChipClassName(value: unknown): string {
  ...
  if (level === 'MEDIUM') {
    return 'border border-amber-200 bg-amber-50 text-amber-800 dark:border-amber-800/60 dark:bg-amber-950/40 dark:text-amber-100';
  }
  if (level === 'LOW') {
    return 'border border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-800/60 dark:bg-emerald-950/40 dark:text-emerald-100';
  }
