    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center p-8 bg-white rounded-lg shadow-md max-w-md w-full mx-4">
          ...
          <h3 className="text-gray-900 mb-2">Page Not Found</h3>
          <p className="text-gray-600 mb-6">{error || 'This page does not exist or is not accessible.'}</p>
          <button
            onClick={() => navigate('/')}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            <h3 className="text-gray-900">{page.name}</h3>
