...
console.log("Hello from _shared!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement _shared logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "_shared function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/_shared' \
