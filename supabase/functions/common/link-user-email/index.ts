...
console.log("Hello from link-user-email!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement link-user-email logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "link-user-email function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/link-user-email' \
