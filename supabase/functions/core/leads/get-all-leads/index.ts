...
console.log("Hello from get-all-leads!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement get-all-leads logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "get-all-leads function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/get-all-leads' \
