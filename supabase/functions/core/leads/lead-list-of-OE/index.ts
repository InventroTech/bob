...
console.log("Hello from lead-list-of-OE!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement lead-list-of-OE logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "lead-list-of-OE function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/lead-list-of-OE' \
