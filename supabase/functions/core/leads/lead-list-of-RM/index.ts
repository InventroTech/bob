...
console.log("Hello from lead-list-of-RM!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement lead-list-of-RM logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "lead-list-of-RM function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/lead-list-of-RM' \
