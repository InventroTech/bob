...
console.log("Hello from update-lead!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement update-lead logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "update-lead function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/update-lead' \
