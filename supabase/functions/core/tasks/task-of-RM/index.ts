...
console.log("Hello from task-of-RM!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement task-of-RM logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "task-of-RM function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/task-of-RM' \
