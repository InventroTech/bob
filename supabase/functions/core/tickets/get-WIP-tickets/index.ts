...
console.log("Hello from get-WIP-tickets!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement get-WIP-tickets logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "get-WIP-tickets function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/get-WIP-tickets' \
