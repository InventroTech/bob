...
console.log("Hello from get-ticket-data!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement get-ticket-data logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "get-ticket-data function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/get-ticket-data' \
