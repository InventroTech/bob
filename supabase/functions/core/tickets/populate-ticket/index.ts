...
console.log("Hello from populate-ticket!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement populate-ticket logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "populate-ticket function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/populate-ticket' \
