...
console.log("Hello from search-ticket!")
...
Deno.serve(async (req) => {
  ...
  // TODO: Implement search-ticket logic here
  
  return new Response(JSON.stringify({ 
    success: true, 
    message: "search-ticket function called successfully",
    userId: userId 
  }), {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/search-ticket' \
